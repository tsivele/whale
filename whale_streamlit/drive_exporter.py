...
DEVICE_MAP = {
    ...
    "MELINA": [
        "iPhoneXs(70ευρο λεει πισω)",                  # ΚΙΝΗΤΟ 1 · ikoritsara
        ...
        # ── ΝΕΕΣ ΣΥΣΚΕΥΕΣ (Σεπτ 2026) ──────────────────────────────────
        # Μετονόμασέ τες σε φυσική περιγραφή (χρώμα/θήκη) μόλις τις ξεχωρίσεις,
        # ΚΑΙ στο Drive ΚΑΙ εδώ — τα δύο ονόματα πρέπει να ταυτίζονται.
        "iPhone #1",                                   # ΚΙΝΗΤΟ 6
        "iPhone #2",                                   # ΚΙΝΗΤΟ 7
        "iPhone #3",                                   # ΚΙΝΗΤΟ 8
        "iPhone #4",                                   # ΚΙΝΗΤΟ 9
...
# ΠΛΕΓΜΑ 10 ΣΥΣΚΕΥΩΝ — κάθε ώρα ρολογιού φορτώνεται με ΑΚΡΙΒΩΣ 2 λογαριασμούς.
# Ο λόγος δεν είναι ότι οι ώρες αυτές είναι «καλύτερες»: στα 304 βίντεο μετά
# τις 6/7 η ώρα δεν έχει μετρήσιμη επίδραση (p = 0,46). Αυτό που ΕΧΕΙ είναι το
# στοίβαγμα — 1-3 λογαριασμοί/ώρα δίνουν διάμεσο 1.182, 4+ δίνουν 848
# (p = 0,0067, κρατάει και με σταθερή διάρκεια). Άρα: άπλωσε, μη βελτιστοποιείς.
DEVICE_TIMES = {
    # μεσημέρι          βράδυ
    "iPhone #1":                                   ["09:00", "19:00"],
    "iPhone #2":                                   ["09:00", "19:00"],
    "iPhoneSE(Μαυρο με κουμπι)":                   ["10:00", "20:00"],
    "iPhone #3":                                   ["10:00", "20:00"],
    "iPhone11-Με θυκη":                            ["12:00", "21:00"],
    "iPhone #4":                                   ["12:00", "21:00"],
    "iPhone8-Ασπρο Ροζε":                          ["13:00", "22:00"],
    "iPhoneXs-Το κινητο με το Μ πισω το σπασμενο":  ["13:00", "22:00"],
    "iPhoneXs(70ευρο λεει πισω)":                  ["14:00", "23:00"],
    "iPhone #5":                                   ["14:00", "23:00"],
}
...
DEVICE_ACCOUNT = {
    ...
    "iPhoneXs(70ευρο λεει πισω)":                  "ikoritsara",
    # ΣΥΜΠΛΗΡΩΣΕ τα handle μόλις δημιουργηθούν οι νέοι λογαριασμοί.
    "iPhone #1":                                   "—",
    "iPhone #2":                                   "—",
    "iPhone #3":                                   "—",
    "iPhone #4":                                   "—",
